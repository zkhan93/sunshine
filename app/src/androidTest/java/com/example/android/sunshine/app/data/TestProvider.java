...
public class TestProvider extends AndroidTestCase {
    ...
    public void deleteAllRecordsFromProvider() {
        ...
        assertEquals("Error: Records not deleted from Weather table during delete", 0, cursor
                .getCount());
        cursor.close();
        ...
        assertEquals("Error: Records not deleted from Location table during delete", 0, cursor
                .getCount());
        cursor.close();
    }
...
//            assertEquals("Error: WeatherProvider registered with authority: " + providerInfo
// .authority +
...
//        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry
// .CONTENT_TYPE",
...
//        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
//        assertEquals("Error: the WeatherEntry CONTENT_URI with location should return
...
//        assertEquals("Error: the LocationEntry CONTENT_URI should return LocationEntry
// .CONTENT_TYPE",
...
//        );
//
//        TestUtilities.validateCursor("testUpdateLocation.  Error validating location entry
// update.",
...
// resolver
//        TestUtilities.TestContentObserver tco = TestUtilities.getTestContentObserver();
//        mContext.getContentResolver().registerContentObserver(LocationEntry.CONTENT_URI, true,
// tco);
//        Uri locationUri = mContext.getContentResolver().insert(LocationEntry.CONTENT_URI,
// testValues);
//
...
//        );
//
//        TestUtilities.validateCursor("testInsertReadProvider. Error validating WeatherEntry
// insert.",
...
//                null  // sort order
//        );
//        TestUtilities.validateCursor("testInsertReadProvider.  Error validating joined Weather
// and Location Data.",
//                weatherCursor, weatherValues);
//
...
//        );
//        TestUtilities.validateCursor("testInsertReadProvider.  Error validating joined Weather
// and Location Data with start date.",
//                weatherCursor, weatherValues);
//
...
//        );
//        TestUtilities.validateCursor("testInsertReadProvider.  Error validating joined Weather
// and Location data for a specific date.",
//                weatherCursor, weatherValues);
//    }
...
//    }
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for (int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate +=
            ...
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_WIND_SPEED, 5.5 + 0.2 * (float)
                    i);
